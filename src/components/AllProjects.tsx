...
const fallbackProjects = [
  {
    title: "FlavorVerse",
    link: "https://flavor-verse-nine.vercel.app/",
    description:
      "Discover recipes from around the world in one place. Browse by category, search your favorite meals, get a new Today's Pick every visit, and switch to Cook Mode for a distraction-free cooking experience.",
  },
  {
    title: "FocusFly",
    link: "https://focus-fly.vercel.app/",
    description:
      "Study sessions that feel like traveling.Turn your focus time into real-time flights across the globe.Pick a destination, start your session, and stay focused until you land.If you quit early… your flight fails.You’re not studying — you’re flying.",
  },
  {
    title: "Obys Agency",
    link: "https://banditadas.github.io/Obys-Agency/",
    description:
      "A creative agency website featuring advanced animations, smooth scrolling, and interactive elements. The project recreates a modern design-focused website using HTML, CSS, JavaScript, and animation libraries like GSAP for a highly engaging user experience.",
  },
  {
    title: "Exo-Ape",
      ...
      <section className="pt-32 md:pt-40 pb-20 px-4 md:px-8 min-h-screen bg-[#EBEAE9] dark:bg-[#141517] transition-colors duration-300 flex flex-col">
        <div className="max-w-6xl mx-auto w-full">
          <div className="mb-12 md:mb-20">
            <Link
              to="/"
              className="inline-flex items-center gap-2 text-sm font-medium opacity-60 hover:opacity-100 transition-opacity mb-8"
            >
